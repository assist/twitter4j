...
public final class HttpParameter implements Comparable<HttpParameter>, java.io.Serializable {
    private static final long serialVersionUID = 4046908449190454693L;
    ...
    public boolean equals(Object o) {
        ...
        if (value != null ? !value.equals(that.value) : that.value != null)
            return false;
        if (jsonBody != null ? !jsonBody.equals(that.jsonBody) : that.jsonBody != null)
            return false;
    ...
    public String toString() {
        return "PostParameter{" + "name='" + name + '\'' + ", value='" + value + '\'' + ", file=" + file + ", fileBody=" + fileBody + ", jsonBody='" + jsonBody + "'}";
    }
    ...
    public int compareTo(HttpParameter o) {
        ...
        } else if (hasJsonBody() && o.hasJsonBody()) {
            compared = jsonBody.compareTo(o.jsonBody);
        }
        return compared;
    }
    ...
    /**
     * @param value
     *            string to be decoded. The natural opposite of encode() above.
     * @return encoded string
     * @see <a href="http://wiki.oauth.net/TestCases">OAuth / TestCases</a>
     * @see <a href="http://groups.google.com/group/oauth/browse_thread/thread/a8398d0521f4ae3d/9d79b698ab217df2?hl=en&lnk=gst&q=space+encoding#9d79b698ab217df2">Space encoding -
     *      OAuth | Google Groups</a>
    ...
    public static boolean isJsonBody(HttpParameter[] parameters) {
        boolean isJsonBody = false;
        for (HttpParameter param : parameters) {
            if (param.hasJsonBody()) {
                isJsonBody = true;
                break;
            }
        }
    ...
    public static String getJsonBody(HttpParameter[] parameters) {
        String jsonBody = null;
        for (HttpParameter param : parameters) {
            if (param.hasJsonBody()) {
                jsonBody = param.getJsonBody();
                break;
            }
        }
        return jsonBody;
