...
public class HTMLEntityTest extends TestCase {
    ...
    public void testUnescapeAndSlideEntityIndices() throws Exception {
        ...
        // "entities":{"hashtags":[{"text":"test","indices":[11,16]}],"urls":[{"url":"http:\/\/t.co\/HwbSpYFr","expanded_url":"http:\/\/twitter4j.org\/en\/index.html#download","display_url":"twitter4j.org\/en\/index.html#\u2026","indices":[49,69]}],"user_mentions":[{"screen_name":"null","name":"not // quite
        ...
        URLEntityJSONImpl t4jURL = new URLEntityJSONImpl(49, 69, "http://t.co/HwbSpYFr", "http://twitter4j.org/en/index.html#download", "twitter4j.org/en/index.html#\u2026");
        ...
        String escaped = HTMLEntity.unescapeAndSlideEntityIndices(json.getString("text"), new UserMentionEntity[] { t4j_news, nil }, new URLEntity[] { t4jURL },
                        new HashtagEntity[] { test }, new MediaEntity[] { media });
    ...
    public void testUnescapeAndSlideEntityIncdicesWithNullParameters() throws Exception {
        String rawJSON = "{\"text\":\"@null &lt; #test &gt; &amp;\\u307b\\u3052\\u307b\\u3052 @t4j_news %&amp; http:\\/\\/t.co\\/HwbSpYFr http:\\/\\/t.co\\/d4G7MQ62\"}";
        JSONObject json = new JSONObject(rawJSON);
        String escaped = HTMLEntity.unescapeAndSlideEntityIndices(json.getString("text"), null, null, null, null);
        assertEquals("@null < #test > &ほげほげ @t4j_news %& http://t.co/HwbSpYFr http://t.co/d4G7MQ62", escaped);
    }
    ...
    public void testUnescapeAndSlideEntityIncdicesWithURLEntitiesOnly() throws Exception {
        ...
        String rawJSON = "{\"text\":\"@null &lt; #test &gt; &amp;\\u307b\\u3052\\u307b\\u3052 @t4j_news %&amp; http:\\/\\/t.co\\/HwbSpYFr http:\\/\\/t.co\\/d4G7MQ62\"}";
        JSONObject json = new JSONObject(rawJSON);
        String escaped = HTMLEntity.unescapeAndSlideEntityIndices(json.getString("text"), null, new URLEntity[] { t4jURL }, null, null);
        assertEquals("@null < #test > &ほげほげ @t4j_news %& http://t.co/HwbSpYFr http://t.co/d4G7MQ62", escaped);
        assertEquals("http://t.co/HwbSpYFr", escaped.substring(t4jURL.getStart(), t4jURL.getEnd()));
    }
    ...
    public void testUnescape() {
        ...
        original = "\\u5e30%u5e30 &lt;%}& foobar &lt;&Cynthia&gt;";
        expected = "\\u5e30%u5e30 <%}& foobar <&Cynthia>";
        assertEquals(expected, HTMLEntity.unescapeAndSlideEntityIndices(original, new UserMentionEntity[] {}, new URLEntity[] {}, new HashtagEntity[] {}, new MediaEntity[] {}));
    }
    ...
    public void testUnescapeAndSlideEntityIncdicesWithCorrectedIndices() throws Exception {
        ...
        JSONObject json = new JSONObject(rawJSON);
        String escaped = HTMLEntity.unescapeAndSlideEntityIndices(json.getString("text"), null, null, new HashtagEntity[] { test1, test2, test3, test4 }, null);
